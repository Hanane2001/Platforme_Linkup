    ...
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="relative">
            <textarea
                name="description"
                rows="4"
                class="w-full p-4 rounded-xl bg-gray-50 dark:bg-[#1C1C1B] border border-gray-200 dark:border-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
        ...
        class="space-y-3">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <!-- Bouton publier -->
                <button type="submit"
                        class="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-all shadow-md hover:shadow-lg">
                    Publier
                </button>
            </div>
        </div>
